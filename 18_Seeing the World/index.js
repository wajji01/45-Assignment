...
var FavCountry = ["Pakistan", "Saudi Arab", "America", "China"];
// • Print your array in its original order.
console.log("Original Order :", FavCountry);
// Print your array in alphabetical order without modifying the actual list.
console.log("alphabetical order :", __spreadArray([], FavCountry, true).sort());
// Show that your array is still in its original order by printing it.
console.log("still in its original order :", FavCountry);
// Print your array in reverse alphabetical order without changing the order of the original list.
console.log("reverse alphabetical order :", __spreadArray([], FavCountry, true).reverse());
